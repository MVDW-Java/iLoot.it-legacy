<?php
	...
	if( isset($_GET["sl"])){
		$sql="SELECT * FROM skinnylinks WHERE shorter='".$_GET["sl"]."'";
		$rs=mysqli_query($con,$sql);
		$row=mysqli_fetch_array($rs);
...
<html>
	<head>
		...
		<title><?php echo $name; ?> | MasterPartner</title>
						...
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							...
							<div class="row form-group">
								<p>
									...
									?>
									<b>Note:</b> The bot is still in early stages, bugs can exist or some functions are not compleet yet.
									<br /><br />
									Master partner is a discord bot that will grow your discord server and will provide you gems to spend in get rewards.
									It will automaticly partner random discord servers so you can get more people attracted to your server.
									The way you can make gems of it is because the random discord servers are paying you gems to put on your server.
									Also when someone go to that invite link on your server you get extra gems of it because there are some ads when we check for bots.
									<br /><br />
									Why waiting? invite the bot today!
									<br /><a href="https://discordapp.com/oauth2/authorize?client_id=352835192794382338&permissions=8&scope=bot" class="btn btn-primary btn-lg btn-custom">Invite masterpartner</a>
									<br /><br />
									<h2>Documentation</h2>
									We need to setup the bot first, type "{verify (product key)" on your discord server.<br />
									Remember your product key can be found on your profile page under "User information".
									When it sayed that you are verified you can now set up the bot by typing "{setup".<br />
									The bot will ask you questions like how many message or in which channel.<br />
									When everything is setup you are ready to go!<br />
								</p>
							</div>	
						</div>
					</div>
