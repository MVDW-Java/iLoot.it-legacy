			...
			<nav class="colorlib-nav">
				<div class="top-menu">
					<div class="container">
						<div class="row">
							<div class="col-md-2">
								<div id="colorlib-logo"><a href="/"><img src="/assets/images/logo.png" width="128" alt="iLoot.it"></a></div>
							</div>
						...
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							...
							<form id="login" method="post">
								...
								<div class="row form-group">
									...
									<div class="col-md-4">
										<button class="h-captcha btn btn-primary" data-sitekey="fb530620-c446-4e98-a99e-f93d2a724456" data-callback="onSubmit">Login</button>
									</div>
									<div class="col-md-4">
										<input type="checkbox" class="16bit_checkbox" name="rememberme" value="yes" id="thing"><label for="thing"></label> Remember me
									</div>
...
<iframe data-aa="1387426" src="//ad.a-ads.com/1387426?size=468x60" scrolling="no" style="width:468px; height:60px; border:0px; padding:0; overflow:hidden" allowtransparency="true"></iframe>
<script src="https://iloot.it/assets/php/banner.php"></script>
<br>
<?php
