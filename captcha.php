<?php
	...
	if(isset($_POST['h-captcha-response']) && !empty($_POST['h-captcha-response'])){
		...
		$secret = '';
		$verifyResponse = file_get_contents('https://hcaptcha.com/siteverify?response='.$_POST['h-captcha-response'].'&secret='.$secret.'&remoteip='.$_SERVER['REMOTE_ADDR']);
		...
		if($responseData->success){
			...
			if ($count == 1) {
				...
				$sql1 = "UPDATE members SET points='" . $points . "', time='" . time() . "' WHERE username='" . $_SESSION['email'] . "'";
				// $sql1 = "INSERT INTO core_fast_save (product_id, email, time, data_1) VALUES ('1', '$username', '".$time."', '$pointsAdd');";
				mysqli_query($con, $sql1);
	
	
				$update = "CAPTCHA > ADD VALUE";
	
				$sql = "INSERT INTO users_history (email, date, log, value) VALUES ('$username', '".$time."', '$update', '$pointsAdd');";
				mysqli_query($con, $sql);
				$sql = "INSERT INTO captcha_history (email, time) VALUES ('".$_SESSION['email']."', '".date("d/m/Y h:i")."');";
				mysqli_query($con, $sql);
    				$_SESSION["message"] = "Earnings have been transferred successfully!";
			} else {
			...
			$_SESSION["error"]  = 'Something faild, please try again!';
		}
	}
	...
	<head>
		...
		<script type="text/javascript">
			function onSubmit(token) {
				document.getElementById("hcaptcha").submit();
			};
		</script>
						...
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							...
							<form id="hcaptcha" method="post">
								...
								<div class="row form-group">
									<div class="col-md-12">
										<input type="hidden" name="site_key" value="fb530620-c446-4e98-a99e-f93d2a724456">
								...
								<div class="row form-group">
									<div class="col-md-12">
										<button class="h-captcha btn btn-primary" data-sitekey="fb530620-c446-4e98-a99e-f93d2a724456" data-callback="onSubmit">Earn now!</button>
