			...
			<nav class="colorlib-nav">
				<div class="top-menu">
					<div class="container">
						<div class="row">
							<div class="col-md-2">
								<div id="colorlib-logo"><a href="https://www.iloot.it"><img src="/assets/images/logo.png" width="128" alt="iLoot.it"></a></div>
							</div>
			...
			<div id="colorlib-contact">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							...
							?>
<?php
$url = 'https://RadioEarn.com/api/get.php?uid=97530&api=JSMKzeFWXc5bw8adjN&out=2';
...
<center>
<?php 
$randomnum = rand(1,6139);
?>
<iframe id="TheID" src="https://radioearn.com/radio/2/start.php?uid=97530&suid=<?php echo $randomnum; ?>"></iframe>
</center>
<script>
...
document.querySelector("#alert-text").textContent = "Error: Your ip (<?php echo $_SERVER['HTTP_X_FORWARDED_FOR']; ?>) is already lisining to radio if you think this is a bug feel free to report it in our <a href=>discord.";
document.querySelector("#alert-text").style = "background-color: #f44336";
console.log("Hello world!");
}
</script>
<script type="text/javascript" src="https://g.Cash-ADS.com/banner.php?uid=3352&e=0&p=0&s=0&size=2"></script>
