...
<script
  ...
  crossorigin="anonymous"></script>
	...
	<body style="display: none; ">
				...
				<div class="top-menu">
					<div class="container">
						<div class="row">
							...
							<div id="colorlib-logo"><a href="https://www.iloot.it"><img src="/assets/images/logo.png" width="128" alt="<?php echo $name; ?>"></a></div>
        ...
        <script type="text/javascript" src="./easteregg/easteregg1/jquery.snowfall.js"></script>
...
function myAjax() {
if(counter > 1) {
$.snowfall.start({content: '<img class="fa fa-snowflake-o" src="./easteregg/easteregg1/logo.png" height="42" width="42">'});
document.title = "[*] Iloot.it | Clicker [*]";
document.querySelector("#home > div.display-t.text-center > div > div > div > div > h2").textContent = "Made By Dominik & MVDW";
playSound("/mario.mp3");
}
counter += 1;
}
...
function playSound(url){
  ...
  document.body.appendChild(audio);
									...
									<img onclick="myAjax()"; style="width: 75%; max-width: 512px;" src="/assets/images/logo.png" alt="iLoot.it">
...
?>
<iframe data-aa="1388590" src="//ad.a-ads.com/1388590?size=970x250" scrolling="no" style="width:970px; height:250px; border:0px; padding:0; overflow:hidden" allowtransparency="true"></iframe>
						</div>
					</div>
				</div>
