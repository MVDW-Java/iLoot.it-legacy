...
<html>
	<head>
		...
		<script src="/assets/js/meme.js"></script>
	</head>
			...
			<nav class="colorlib-nav" role="navigation">
				<div class="top-menu">
					<div class="container">
						<div class="row">
							<div class="col-md-2">
								<div id="colorlib-logo"><a href="/"><img src="/assets/images/logo.png" width="128px" alt="<?php echo $name; ?>"></a></div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							<div class="alert green" id="alert-box" style="display: none;">
	  							<span class="closebtn" onclick="this.parentElement.style.display='none';">&times;</span> 
	  							<p id="alert-box-content">test</p>
							</div>


							<h2><?php echo $menu_profile; ?></h2>
							<div class="row form-group">
								<p><?php echo $profile_note; ?></p>
								...
								<div class="table_body">
									<div class="table_head">
										<div id="page" style="overflow: hidden;">
											<nav class="colorlib-nav" role="navigation">
												<div class="top-menu" style="overflow: hidden; margin: 0px !important; padding: 25px;">
													<div class="container">
														<div class="row">
															<div class="col-md-2" style="overflow: hidden; width: 750px; margin: 0px !important; padding: 0px; ">
																<div style="color: #ffffff; font-size: 20px; width: 250px; float:left;"><?php echo $profile_change_settings; ?></div>
																<div style="color: #ffffff; font-size: 20px; width: 250px; float: left;"><?php echo $profile_statistics; ?></div>
																<div style="color: #ffffff; font-size: 20px; width: 240px; float: left;"><?php echo $profile_user_information; ?></div>
															</div>
														</div>
													</div>
												</div>
										...
										<br \>
										<div class="table_sec1" style="width: 250px; float:left;">
                                                                                      	<a href="changenickname">Change Nickname</a><br />
											<a href="change.php?type=email"><?php echo $profile_change_email; ?></a><br />
											<a href="change.php?type=pass"><?php echo $profile_change_password; ?></a><br />
											<form action="/assets/php/translate.php">
												<select name="lang">
													<option <?php if($translate_id == "EN") echo " selected"; ?> value="EN">English (Default)</option>
													<option <?php if($translate_id == "NL") echo " selected"; ?> value="NL">Nederlands</option>
													<option <?php if($translate_id == "RO") echo " selected"; ?> value="RO">Rom&acirc;n&#259;</option>
                                                                                                        <option <?php if($translate_id == "PL") echo " selected"; ?> value="PL">Polski</option>
													<option value="FR" disabled>Fran&ccedil;ais</option>
													<option value="DE" disabled>Deutsch</option>
												</select>
												<input type="submit" class="btn btn-primary" value="<?php echo $profile_change_language; ?>">
											</form>
										</div>
										<div class="table_sec1" style="width: 250px; float:left;">

											Capthers Done: <?PHP include("assets/php/capthersdone.php"); ?> 
											<?php include("assets/php/code_uses.php"); ?>
<?php if($dailyo == "yes"){ ?>
<form action="/assets/php/daily.php">
<button type="submit" class="btn btn-primary" value="Daily">Daily</button>
</form>
<?php } else { ?>
<button type="submit" class="btn btn-primary" value="Daily" disabled>Wait</button>
<?php }; ?>
								</div>
										<div class="table_sec1" style="width: 250px; float:left;">

											<p id="username-text"></p>
											<p id="passwordchangedate"></p>
											<?PHP include("assets/php/check_token_regenerate.php"); ?><p id="usertoken-text"></p>
                                                                                        <p title="Click on me to copy!" id="

ID-text" onclick="copyElementText(this.id)"><?PHP include("assets/php/usertoken.php"); ?></p>
<script>
											...
											var elem = document.createElement("textarea");
    											...
    											document.body.removeChild(elem);
                                                                                        alert("You token got copy to you clipboard!\nToken: <?PHP include("assets/php/usertoken.php"); ?>")
										}
</script>
                                                                                        
											(<a href="/assets/php/discord.php?action=login">Discord</a>)<p id="discordID-text"></p>
                                                                                        <?PHP include("assets/php/discordlogin.php"); ?>
										</div>
									</div>
								</div>
								<script>
									var xhr = new XMLHttpRequest();
									xhr.open("POST", '/api/@me/profile', true);
									...
									xhr.onreadystatechange = function() {
										if (this.readyState === XMLHttpRequest.DONE && this.status === 200) {
											...
											document.getElementById("username-text").innerHTML = json.data.username;
											document.getElementById("passwordchangedate").innerHTML = json.data.passwordChangeDate;
			
											var discordID = json.data.discordID;
											var usertoken = json.data.usertoken;
			
											if (usertoken == "") {
												document.getElementById("usertoken-text").innerHTML = "<a href='token_generator.php'>Generate</a>";
											} else {
												document.getElementById("usertoken-text").innerHTML = usertoken;
											}
			
											if (discordID == "") {
												document.getElementById("discordID-text").innerHTML = "<a href=\"#\" onClick=\"window=window.open('https://iloot.it/assets/php/discord.php','window',width=128,height=250);\">Click to connect your account with Discord.</a>";
											} else {
												document.getElementById("discordID-text").innerHTML = discordID;
											}
    										}
									}
									xhr.send(""); 
