...
$sql = "UPDATE members SET nickname='". htmlspecialchars($_POST["uname"]) ."' WHERE username='" . $_SESSION['email'] . "'"; 
...
<html lang="en">
	<head>
		...
		<title>iLoot.it | Change Nickname</title>
...
<form action = "" method = "post">
    <input type="text" placeholder="Enter New Nickname" name="uname" class="form-control" required>
</input>
<br>
