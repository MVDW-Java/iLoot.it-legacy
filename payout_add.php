<?php
	...
	$count = 0;
	if($count == 1 && row["paypal"] !== "") {
		$save_edit_paypal = "Edit PayPal";
	} else {
		$save_edit_paypal = "Save PayPal";
	}
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							...
							?>
							<h2>Add payment: PayPal</h2>


							<form action="payout_add" method="POST">

								<div class="row form-group">
									<div class="col-md-10">
										<input type="text" name="paypal_email" id="paypal_email" class="form-control" placeholder="Enter your PayPal Email here...">
									</div>
									<div class="col-md-2">
										<input type="submit" value="<?php echo $save_edit_paypal; ?>" class="btn btn-primary">
									</div>
