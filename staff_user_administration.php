<?php
	...
	if(!$permissions_manage_users){
		$_SESSION["error"] = "NO PERMISSIONS";
...
<html lang="en">
	<head>
		...
		<title>iLoot.it | User administration</title>
						...
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							...
							<div class="row form-group">
								<div class="col-md-12">
									...
									<tr><th>Email</th><th style="width: 400px">Money</th><th>Actions</th></tr>
									...
									<?php
										...
										while ($row = mysqli_fetch_assoc($result)) {
											echo "<tr><td>" . $row['username'] . "</td><td style=\"width: 400px\">" . $row["points"]/100000 . "</td><td><button>Ban</button></td></tr>";
											$money = $money + $row["points"];
										}
		
										echo "</table>";

										echo "Total user money: " . $money/100000 ;
									?>
