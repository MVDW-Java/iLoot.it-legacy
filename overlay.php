...
<html>
	<head>
		...
		<title><?php echo $name; ?> | OverLay</title>
						...
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							...
							<div class="row form-group">
								<p>
									...
									?>
									<b>Note:</b> We are still working on overlay, but you can download the first In-Dev version
									<br /><br />
									Overlay is a extention/App/Program that will put advertisements to gain faster money on iLoot.it.<br />
									Our responsive program and AI will put ads on the on your window/tab while it will not distract anyone.<br />
									You can watch videos while a ad is showing below the fullscreen video.<br />
									<br />
									You can download it in the google chrome store and will be ready for use.<br />V0.1.0:<br>
									<a href='https://chrome.google.com/webstore/detail/ilootit-overlay/bkgbgegdcedfkjfbiocllmhpnmeidjec'><img width="254px" src="https://iloot.it/assets/images/ChromeWebStore_BadgeWBorder_v2_496x150.png" alt="Available in the Chrome Web Store"></a><br><!-- V0.1.0:
									<br /><a href="http://www.mediafire.com/file/c122892ldki7sda/iLoot.it_google_chrome_edition.crx/file">Want to have the Alpha version before they will be released? Click here to download it!</a><br> -->
									 Release note v0.1.0:<br />- Added close ad button.<br />- Bug fixes.<br />- Some frame changes.<br /><br />Release note v0.0.1:<br />- First release 
