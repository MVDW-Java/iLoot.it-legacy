...
<html lang="en">
	<head>
		...
		<title>iLoot.it | Leaderboard</title>
...
include("assets/php/connect.php");
                echo "<tr style=\"background-color: #1FF4F7;\"><td>Advertise:</td>
                      <td><a href=\"profile.php\" style=\"color:gray\"><img src='/logo.png' height=35 width=35 id=\"p02\">Join Our Discord!</a></img></td>
                      <td><a href=\"https://discord.gg/uyZeDDJ\">Discord Invite</a></td></tr>";

              $sql="SELECT * FROM members ORDER BY points DESC LIMIT 11";
...
if($rank == 1){
	if(strlen($row['nickname']) == 0) {
                echo "<tr style=\"background-color: #FFD700;\"><td>". $rank ."</td>
                      <td><a href=\"profile.php\" style=\"color:gray\"><img src='assets/images/defult.png' height=35 width=35 id=\"p02\">Anonymous</a></img></td>
                      <td>$". $calc ."</td></tr>";
	} else {
                echo "<tr style=\"background-color: #FFD700;\"><td>". $rank ."</td>
                      <td><a href=\"profile.php\" style=\"color:gray\"><img src=". $imagree ." height=35 width=35 id=\"p02\">   ". $row['nickname'] ."</a></img></td>
                      <td>$". $calc ."</td></tr>";
	};
} else if($rank == 2){
	if(strlen($row['nickname']) == 0) {
                echo "<tr style=\"background-color: #C0C0C0;\"><td>". $rank ."</td>
                      <td><a href=\"profile.php\" style=\"color:gray\"><img src='assets/images/defult.png' height=35 width=35 id=\"p02\">Anonymous</a></img></td>
                      <td>$". $calc ."</td></tr>";
	} else {
                echo "<tr style=\"background-color: #C0C0C0;\"><td>". $rank ."</td>
	...
	if(strlen($row['nickname']) == 0) {
                echo "<tr style=\"background-color: #D3D3D3;\"><td>". $rank ."</td>
                      <td><a href=\"profile.php\" style=\"color:gray\"><img src='assets/images/defult.png' height=35 width=35 id=\"p02\">Anonymous</a></img></td>
                      <td>$". $calc ."</td></tr>";
	} else {
                echo "<tr style=\"background-color: #D3D3D3;\"><td>". $rank ."</td>
	...
	if(strlen($row['nickname']) == 0) {
                echo "<tr style=\"background-color: #FFFFFF;\"><td>". $rank ."</td>
                      <td><a href=\"profile.php\" style=\"color:gray\"><img src='assets/images/defult.png' height=35 width=35 id=\"p02\">Anonymous</a></img></td>
                      <td>$". $calc ."</td></tr>";
	} else {
                echo "<tr style=\"background-color: #FFFFFF;\"><td>". $rank ."</td>
