<?php
	...
	if(!isset($_SESSION["email"]) ){
		header("location:login.php?message=You need to login to do that.");
	} else {
	...
	if($_GET['type'] == "email"){
		...
		header("location:profile.php?error=Oops... something whent wrong.");
	}
...
<html>
	<head>
		...
		<title><?php echo $name; ?> | Change <?php echo $type; ?></title>
			...
			<nav class="colorlib-nav" role="navigation">
				<div class="top-menu">
					<div class="container">
						<div class="row">
							<div class="col-md-2">
								<div id="colorlib-logo"><a href="https://www.iloot.it"><img src="/assets/images/logo.png" width="128px" alt="<?php echo $name; ?>"></a></div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							<?php 
								if($type_sum == 1){
									echo "<form action=\"changeemail\" method=\"POST\">";
									echo "<h1>Change email:</h1>";
									echo "<span>or <a href=\"profile\">go back</a></span><br />";
									if(!empty($_GET['message'])){
										echo "<p style='color: red'>" . $_GET['message'] . "</p>";
									}
									echo "<div class=\"row form-group\">";
									echo "<div class=\"col-md-12\">";
									echo "<input type=\"email\" name=\"email1\" class=\"form-control\" placeholder=\"New email\">";
									echo "</div>";
									echo "</div>";

									echo "<div class=\"row form-group\">";
									echo "<div class=\"col-md-12\">";
									echo "<input type=\"email\" name=\"email2\" class=\"form-control\" placeholder=\"Confirm new email\">";
									echo "</div>";
									echo "</div>";
									...
									echo "<input type=\"submit\" value=\"Change email\" class=\"btn btn-primary\">";
									echo "</div>";
									echo "</form>";
									...
									echo "<div class=\"row form-group\">";
									echo "<div class=\"col-md-12\">";
									echo "<input type=\"password\" name=\"password1\" class=\"form-control\" placeholder=\"Password\">";
									echo "</div>";
									echo "</div>";

									echo "<div class=\"row form-group\">";
									echo "<div class=\"col-md-12\">";
									echo "<input type=\"password\" name=\"password2\" class=\"form-control\" placeholder=\"New password\">";
									echo "</div>";
									echo "</div>";

									echo "<div class=\"row form-group\">";
									echo "<div class=\"col-md-12\">";
									echo "<input type=\"password\" name=\"password3\" class=\"form-control\" placeholder=\"Confirm new password\">";
									echo "</div>";
									echo "</div>";
									echo "<div class=\"form-group\">";
									echo "<input type=\"submit\" value=\"Change password\" class=\"btn btn-primary\">";
									echo "</div>";
									echo "</form>";	
}						
							?>
