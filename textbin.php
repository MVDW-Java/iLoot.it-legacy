				...
				<div class="top-menu">
					<div class="container">
						<div class="row">
							...
							<?php 
								if(isset($_GET["link"]) && isset($_GET["logo_url"]) && isset($_GET["logo_alt"])){

									echo "<div class=\"col-md-2\">";
									echo "<div id=\"colorlib-logo\"><a href=\"" . $_GET['link'] . "\"><img src=\"" . $_GET['logo_url'] . "\" width=\"52\" alt=\"" . $_GET['logo_alt'] . "\"></a></div>";
									echo "</div>";
								}
							?>
