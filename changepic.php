...
$sql = "UPDATE members SET avatar='". htmlspecialchars($_POST["uname"]) ."' WHERE username='" . $_SESSION['email'] . "'"; 
...
<html lang="en">
	<head>
		...
		<title>iLoot.it | Change Avatar</title>
...
<form action = "" method = "post">
    <input type="text" placeholder="Enter Link To Avatar" name="uname" class="form-control" required>
</input>
<br>
