...
# Initialize library and don't require authentication.
$lib = new Lib(false);
...
<html>
	<head>
		...
		<title>iLoot.it | Calculator</title>
	...
	<body style="visibility: hidden !important;">
		...
		<div id="page">
			<nav class="colorlib-nav" role="navigation">
				<div class="top-menu">
					<div class="container">
						<div class="row">
							<div class="col-md-2">
								<div id="colorlib-logo"><a href="https://www.iloot.it"><img src="/assets/images/logo.png" width="128px" alt="iLoot.it"></a></div>
							</div>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							...
							<span>Hours of watching advertisements per day.</span>
							<div class="row form-group">
								<div class="col-md-12">
									<input type="number" id="adsHoursPerDay" class="form-control" placeholder="Advertisement hours per day.">
								</div>
							</div>
		
							<span>Hours of the miner running per day.</span>
							<div class="row form-group">
								<div class="col-md-12">
									<input type="number" id="minerHoursPerDay" class="form-control" placeholder="Miner hours per day.">
								</div>
							</div>
								
							<span>Average hashes per second.</span>
							<div class="row form-group">
								<div class="col-md-12">
									<input type="number" id="hashesPerSecond" class="form-control" placeholder="Average hashes per second.">
								</div>
							</div>
							
							<h3 id="profit">Profit per day: $0<h3/>
			...
			<script>
				document.getElementById("adsHoursPerDay").onchange = updateCalculator;
				document.getElementById("minerHoursPerDay").onchange = updateCalculator;
				document.getElementById("hashesPerSecond").onchange = updateCalculator;
				
				function updateCalculator() {
					var adsHoursPerDay = parseFloat(document.getElementById("adsHoursPerDay").value);
					var minerHoursPerDay = parseFloat(document.getElementById("minerHoursPerDay").value);
					var hashesPerSecond = parseInt(document.getElementById("hashesPerSecond").value);
					
					if (adsHoursPerDay > 24) {
						adsHoursPerDay = 24;
					}
					
					if (minerHoursPerDay > 24) {
						minerHoursPerDay = 24;
					}
					
					var adProfitHour = 0.02880
					var minerProfitHourPerHash = 0.0003;
					
					var profit = ((adsHoursPerDay ? adsHoursPerDay : 0) * adProfitHour) + 
					((minerHoursPerDay ? minerHoursPerDay : 0) * minerProfitHourPerHash * (hashesPerSecond ? hashesPerSecond : 0));
					
					profit = Math.round(profit * 10000) / 10000;
					
					document.getElementById("profit").innerHTML = "Profit per day: $" + profit;
				}
			</script>
