...
<html>
	<head>
		...
		<title><?php echo $name; ?> | Privacy</title>
...
<p>iLoot.it ("us", "we", or "our") operates the https://iloot.it website and the  mobile application (the "Service").</p>
...
<p>iLoot.it uses the collected data for various purposes:</p>    
<ul>
...
<p>iLoot.it will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

<h3>Disclosure Of Data</h3>

<h4>Legal Requirements</h4>
<p>iLoot.it may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
<ul>
    <li>To comply with a legal obligation</li>
    <li>To protect and defend the rights or property of iLoot.it</li>
...
<ul>
        <li>By email: maxvdwolf@gmail.com</li>
            <li>By visiting this page on our website: https://iloot.it/helpcenter</li>
