...
$con=mysqli_connect("$host", "$username", "$password","$db_name");
				...
				$sql = "SELECT * FROM staff_coins WHERE user='" . $_GET['discordid'] ."'";
				$rs = mysqli_query($con,$sql);
				$row = mysqli_fetch_array($rs);
				$count = mysqli_num_rows($rs);
if($count != 1) {
$coins = "Sorry but we don't have you register as staff";
} else {
...
<html lang="en">
	<head>
		...
		<title>iLoot.it | Staff Squad</title>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center colorlib-heading animate-box">
							<u><h2><b>Staff Squad</b></h2></u>
							<br>
 							<h1><?php if($count != 1) { } else { echo "ID: " .$row['user']. ""; }; ?></h1>
							<h1><?php echo $coins; ?></h1>
