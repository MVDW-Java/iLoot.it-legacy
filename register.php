<?php
	...
	if(isset($_GET["execute"])){
		if($_GET["execute"] == "REMOVE_SPONSOR"){
			if(isset($_SESSION["sponsor"])) {
				//unset($_SESSION["sponsor"]);
				//$_SESSION["message"] = "You don't support him/her anymore.";
				$_SESSION["error"] = "You can't remove the support on this user.";
			} else {
				$_SESSION["error"] = "You don't support anymore";
			}
		}	
	}

	if(isset($_SESSION["sponsor"])){
		$_SESSION["message"] = "<p>Thank you for supporting <b>" . $_SESSION["sponsor"] . "</b></p><p style=\"font-size: 12px;\"><a style=\"color: #fff;\" href=\"?execute=REMOVE_SPONSOR\">If you don't want to support <b>" . $_SESSION["sponsor"] . "</b>, please click here.</a><p>";
	
	}

	if(isset($_POST["email"])){
		include("assets/php/checkregister.php");
	}
						...
						<div class="col-md-12 col-md-offset-0 text-center colorlib-heading animate-box">
							...
							<form id="register" method="POST">
								...
								<div class="row form-group">
									<div class="col-md-6">
										<input type="email" name="email" <?php if(isset($_SESSION['register_email'])) echo "value=\"" . $_SESSION['register_email'] . "\""; ?> id="email" class="form-control" placeholder="Email">
									</div>
									<div class="col-md-6">
										<input type="text" name="name" <?php if(isset($_SESSION['register_name'])) echo "value=\"" . $_SESSION['register_name'] . "\""; ?> id="name" class="form-control" placeholder="Full name">
									</div>
								...
								<div class="row form-group">
									<div class="col-md-6">
										<input type="password" name="password1" <?php if(isset($_SESSION['register_password1'])) echo "value=\"" . $_SESSION['register_password1'] . "\""; ?> id="password1" class="form-control" placeholder="Password">
									</div>
									<div class="col-md-6">
										<input type="password" name="password2" <?php if(isset($_SESSION['register_password2'])) echo "value=\"" . $_SESSION['register_password2'] . "\""; ?> id="password2" class="form-control" placeholder="Confirm password">
									</div>
								...
								<div class="row form-group">
									...
									<div class="col-md-8">
										<input type="checkbox" class="16bit_checkbox" name="terms" value="tos" id="thing"><label for="thing"></label> Do you accept our <a href="terms">terms of service</a> and <a href="privacy">Privacy Policy</a>?
									</div>

									<div class="col-md-4">
										<button class="h-captcha btn btn-primary" data-sitekey="fb530620-c446-4e98-a99e-f93d2a724456" data-callback="onSubmit">Register</button>
									</div>
